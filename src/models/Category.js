...
module.exports = {
  ...
  get: function(req, callback){
    mysqlConnection.query('SELECT * FROM categories',callback);
  },

  search: function(req,id,callback){
    mysqlConnection.query('SELECT * FROM categories WHERE id='+id, callback);
  },
  ...
  destroy: function(con, id, callback) {
    mysqlConnection.query(`DELETE FROM categories WHERE id = ${id}`, callback);
  }
