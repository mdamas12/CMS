...
module.exports = {
  ...
  get: function(req, callback){
    mysqlConnection.query('SELECT * FROM brands',callback);
  },

  search: function(req,id,callback){
    mysqlConnection.query('SELECT * FROM brands WHERE id='+id, callback);
  },
  ...
  destroy: function(con, id, callback) {
    mysqlConnection.query(`DELETE FROM brands WHERE id = ${id}`, callback);
  }
